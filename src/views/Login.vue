<template>
  <div>
    <v-app-bar height="50em" color="#F5F5F5" dense flat>
    </v-app-bar>
      ...
      <div class="px-6 py-8">
        <div style="max-width:420px" class="mx-auto">
          ...
          <div class="pt-3">
            <div>
              ...
              <v-text-field
                ...
                name="input-password"
                label="パスワード"
                hint="英数字12桁以上で入力してください。"
                @click:append="passwordShow = !passwordShow"
              ></v-text-field>
            </div>
            <div class="login-btn pb-6">
              <v-btn
          ...
          <v-card-text align="center">
            <p class="ma-0">まだアカウントをお持ちでない方は <router-link to="/signup">新規登録</router-link> に移動</p>
            <p class="ma-0">パスワードを忘れてしまった方は <router-link to="/resetPassword">こちら</router-link> から再設定できます</p>
          </v-card-text>
        </div>
      </div>
      </v-card>
    ...
    <footer style="background: #F5F5F5">
      <div class="pa-8 d-flex flex-warp justify-center fill-wdith">
        <router-link to="privacy" class="link-caption mr-8">プライバシーポリシー</router-link>
        <router-link to="tos" class="link-caption mr-8">利用規約</router-link>
      </div>
    </footer>
  </div>
</template>
